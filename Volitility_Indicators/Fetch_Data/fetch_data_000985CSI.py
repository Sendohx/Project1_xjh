# -*- coding = utf-8 -*-
# @Time: 2023/11/23 12:43
# @Author: Jiahao Xu
# @File：fetch_data_000985CSI.py
# @Software: PyCharm
...
def fetch_data_000985():
    ...
    with conn.cursor() as cursor:
        ...
        price_data = price_data.rename(columns={'S_INFO_WINDCODE': 'symbol', 'TRADE_DT': 'date',
                                                'S_DQ_ADJPRECLOSE': 'pre_close', 'S_DQ_ADJOPEN': 'open',
                                                'S_DQ_ADJHIGH': 'high', 'S_DQ_ADJLOW': 'low', 'S_DQ_ADJCLOSE': 'close'})
    ...
    condition_1 = "S_INFO_WINDCODE = '000985.CSI'"
    condition_2 = "TRADE_DT >= '20191001'"

    index_price_data = fetch_data(conn, table_name_1, columns_1, condition_1, condition_2)
    index_price_data = index_price_data.rename(columns={'S_INFO_WINDCODE': 'symbol', 'TRADE_DT': 'date',
